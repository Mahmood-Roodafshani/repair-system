...
const TextFieldWithFormik = (props: LocalTextFieldProps) => {
    ...
    let formattedValue = props.visualFormatter ? props.visualFormatter(field.value) : field.value;
    return <TextField size={"small"} onChange={handleChange} {...configTextField} variant={"outlined"}
