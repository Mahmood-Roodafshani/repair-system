...
function EditPermissionDialog({ permission, open, onClose, onUpdate }: EditPermissionDialogProps) {
  const handleSubmit = async (values: PermissionDto) => {
    try {
      await permissionService.update(permission.id.toString(), values);
