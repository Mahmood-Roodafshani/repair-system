...
function CreatePermissionDialog({
  ...
  const initialValues: Omit<PermissionManagementDto, 'id'> = {
    name: '',
    description: ''
  };

  const handleSubmit = async (values: Omit<PermissionManagementDto, 'id'>) => {
    try {
      console.log('Mahmood');
      await permissionManagementService.create(values);
