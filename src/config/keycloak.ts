...
const keycloakConfig = {
  ...
  sslRequired: import.meta.env.VITE_KEYCLOAK_SSL_REQUIRED,
  ...
  // Simplify the flow
  responseMode: import.meta.env.VITE_KEYCLOAK_RESPONSE_MODE,
  responseType: import.meta.env.VITE_KEYCLOAK_RESPONSE_TYPE,
